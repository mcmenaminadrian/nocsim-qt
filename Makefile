...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Tue Nov 29 23:04:30 2016
# Project:  noc-qt.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/noc-qt1.0.0/ && $(COPY_FILE) --parents mainwindow.h ControlThread.hpp memory.hpp memorypacket.hpp mux.hpp noc.hpp packet.hpp paging.hpp processor.hpp SAX2Handler.cpp xmlFunctor.hpp tile.hpp tree.hpp .tmp/noc-qt1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp ControlThread.cpp memory.cpp memorypacket.cpp mux.cpp noc.cpp numberpage.cpp paging.cpp processor.cpp xmlFunctor.cpp tile.cpp tree.cpp .tmp/noc-qt1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/noc-qt1.0.0/ && (cd `dirname .tmp/noc-qt1.0.0` && $(TAR) noc-qt1.0.0.tar noc-qt1.0.0 && $(COMPRESS) noc-qt1.0.0.tar) && $(MOVE) `dirname .tmp/noc-qt1.0.0`/noc-qt1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/noc-qt1.0.0
